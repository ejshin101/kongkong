...
<body>
<div class="container" style="margin-top: 130px; margin-bottom:130px;/*  border: 1px solid gray */">
<form:form action="changeModify.wow" name="frmSignup" method="post" modelAttribute="member" >
	<div id="frm_assign" align="center" class="col-auto">
		...
		<div align="center" style="margin: 10px; margin-bottom: 100px;">
			<button type="submit" class="kongkongsDark">변경</button>
		</div>
	</div>
</form:form>
</div>
