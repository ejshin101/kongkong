		...
		<table class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>주문자 수령여부</th>
					<td>
						<label class="k-50"><input type="radio" name="bookPickupYn" value="Y" ${reserve.bookPickupYn eq 'Y' ? "checked='checked'":""} > 예</label>
						<label class="k-50"><input type="radio" name="bookPickupYn" value="N" ${reserve.bookPickupYn eq 'N' ? "checked='checked'":""}> 아니오  </label> 
						<label class="k-50"><input type="radio" name="bookPickupYn" value="" ${empty reserve.bookPickupYn  ? "checked='checked'":""}> 해당없음 </label> 
					</td>
				</tr>
				<tr>
					<th>택배발송여부</th>
					<td>
						<label class="k-50"><input type="radio" name="bookShippingYn" value="Y" ${reserve.bookShippingYn eq 'Y' ? "checked='checked'":""} > 예   </label> 
						<label class="k-50"><input type="radio" name="bookShippingYn" value="N" ${reserve.bookShippingYn eq 'N' ? "checked='checked'":""}> 아니오</label> 
						<label class="k-50"><input type="radio" name="bookShippingYn" value="" ${empty reserve.bookShippingYn ? "checked='checked'":""}> 해당없음</label> 
					</td>
				</tr>
				<tr>
					<th>주문자 반납여부</th>
					<td>
						<label class="k-50"><input type="radio" name="bookReturnYn" value="Y" ${reserve.bookReturnYn eq 'Y' ? "checked='checked'":""} > 예    </label> 
						<label class="k-50"><input type="radio" name="bookReturnYn" value="N" ${reserve.bookReturnYn eq 'N' ? "checked='checked'":""}> 아니오 </label> 
						<label class="k-50"><input type="radio" name="bookReturnYn" value="" ${empty reserve.bookReturnYn ? "checked='checked'":""}> 해당없음 </label> 
					</td>
				</tr>
				<tr>
					<th>구매취소여부</th>
					<td>						
						<label class="k-50"><input type="radio" name="bookDel" value="Y" ${reserve.bookDel eq 'Y' ? "checked='checked'":""} > 예    </label> 
						<label class="k-50"><input type="radio" name="bookDel" value="N" ${reserve.bookDel eq 'N' ? "checked='checked'":""}> 아니오	</label> 				
						<label class="k-50"><input type="radio" name="bookDel" value="" ${empty reserve.bookDel ? "checked='checked'":""}> 해당없음	</label> 				
					</td>
				</tr>			
