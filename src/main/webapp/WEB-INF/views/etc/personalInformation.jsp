...
개인정보처리방침의 의의<br>
콩콩은 본 개인정보처리방침은 개인정보보호법을 기준으로 작성하되, 콩콩 내에서의 이용자 개인정보 처리 현황을 최대한 알기 쉽고 상세하게 설명하기 위해 노력하였습니다.<br>
...
<br>
콩콩가 어떤 정보를 수집하고, 수집한 정보를 어떻게 사용하며, 필요에 따라 누구와 이를 공유(‘위탁 또는 제공’)하며, 이용목적을 달성한 정보를 언제·어떻게 파기하는지 등 ‘개인정보의 한살이’와 관련한 정보를 투명하게 제공합니다.<br>
...
그 무엇보다도, 개인정보와 관련하여 콩콩와 이용자간의 권리 및 의무 관계를 규정하여 이용자의 ‘개인정보자기결정권’을 보장하는 수단이 됩니다.<br>
<br>	
</div>
