...
<body>
<img src="<%=request.getContextPath() %>/resources/image/coin.png" id="flyingObject" class="Factive">
...
function flyingObjectHidden() {
	...
	if(ImgChange == 0){
$('#flyingObject').attr("src", "<%=request.getContextPath() %>/resources/image/coin.png");
$('#flyingObject').addClass('Factive')
$('#flyingObject').css({ 'width': '50px','height':'50px' });
	}else if(ImgChange == 1){
$('#flyingObject').attr("src", "<%=request.getContextPath() %>/resources/image/dollar.gif");
$('#flyingObject').removeClass('Factive')
$('#flyingObject').css({ 'width': '100px','height':'100px' });
	}else if(ImgChange == 2){
$('#flyingObject').attr("src", "<%=request.getContextPath() %>/resources/image/dollar2.gif");
$('#flyingObject').removeClass('Factive')
$('#flyingObject').css({ 'width': '100px','height':'100px' });
	}
