	...
	<div class="page-header">
		...
		<table class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>주문자 수령여부</th>
					<td>${reserve.bookPickupYn}</td>
				</tr>
				<tr>
					<th>택배발송여부</th>
					<td>${reserve.bookShippingYn}</td>
				</tr>
				<tr>
					<th>주문자 반납여부</th>
					<td>${reserve.bookReturnYn}</td>
				</tr>
				<tr>
					<th>구매취소여부</th>
					<td>${reserve.bookDel}</td>
				</tr>
					...
					<td colspan="2">
					  <div class="pull-left">
						...
						<div class="pull-right">
							<a href="reservationAdminModify.wow?bookMerchantUid=${reserve.bookMerchantUid }" class="btn btn-success btn-sm"> 
