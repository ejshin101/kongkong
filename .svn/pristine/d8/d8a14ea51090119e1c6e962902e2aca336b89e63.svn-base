 ...
 <div id="sideBar">
        <nav id="sideNav" class="navbar flex-column align-items-stretch p-3 ">
            <nav class="nav nav-pills flex-column">
                <a class="nav-link ms-3 my-1" href="<%=request.getContextPath()%>/free/freeList.wow">자유게시판</a>
                <a class="nav-link ms-3 my-1" href="<%=request.getContextPath()%>/free/notice.wow">공지사항</a>
                <a class="nav-link ms-3 my-1" href="<%=request.getContextPath()%>/free/tip.wow">팁</a>
                <a class="nav-link ms-3 my-1" href="<%=request.getContextPath()%>/free/qna.wow">QNA</a>
            </nav>
