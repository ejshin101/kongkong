...
#hiddenImage{top: 700px; left: 650px; height:50px; weightr:50px; position:absolute;]}
...
<img src="<%=request.getContextPath() %>/resources/image/white.jpg" id="hiddenImage">
		...
		$.ajax({
			...
			success :function(data){
				if(data.result){
					...
					$('#prize').html("내 마일리지: "+(curMileage-requiredMileage));
