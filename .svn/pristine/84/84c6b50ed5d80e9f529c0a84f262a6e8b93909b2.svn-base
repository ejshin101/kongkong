...
<%@ include file="/WEB-INF/inc/top.jsp"%>
  <div class="hotel-search" style="margin: 50px ">
    <div id="controls">
      <select id="country">
    ...
    <div id="locationField" class="">
      <input id="autocomplete" placeholder="어디로 갈까요?" class="" type="text" />
    </div>
  </div>
  ...
  <div id="google-map" style="margin-bottom: 50px">
    <!--지도 생성위치-->
  </div>
  ...
  <script>
    let map, places, infoWindow, autocomplete,selectedOption;
    let markers = [];
    ...
    function initMap() {
      ...
      document.getElementById("searchOption").addEventListener("change", setAutocompleteSearchOption);
    ...
    function setAutocompleteSearchOption() {
